...
import com.chenchen.factory.map.location.LocationService;
import com.chenchen.factory.map.location.LocationStatusManager;
import com.chenchen.factory.map.Utils;
import com.chenchen.factory.ui.fragment.HintDialogFragment;

import java.util.Arrays;

public class MapActivity extends Activity implements AMapLocationListener,HintDialogFragment.DialogFragmentCallback{
    MapView mapView;
    private AMap aMap;
    ...
    private BroadcastReceiver locationChangeBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(RECEIVER_ACTION)) {
                ...
                Log.i("MY", "onReceive: "+locationResult);
    ...
    private void requestPermission(int permissioncode) {
        ...
        if (!IsEmptyOrNullString(permission)){
            ...
            Log.i("MY", "requestPermission: "+permission);
    ...
    public void onRequestPermissionsResult(int requestCode,String permissions[], int[] grantResults) {
        switch (requestCode) {
            case LOCATION_PERMISSION_CODE: {
                // If request is cancelled, the result arrays are empty.(如果请求取消，结果数组为空)
...
//            default:
        ...
        Log.i("MY", "onRequestPermissionsResult: \npermissions=>"+ Arrays.toString(permissions)+"\ngrantResults=>"+grantResults);
//        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
    ...
    public void doNegativeClick(int requestCode) {
        Toast.makeText(this, "用户点击了取消按钮", Toast.LENGTH_SHORT).show();
    }
