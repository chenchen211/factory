package com.chenchen.factory.map.navi;
...
import com.chenchen.factory.map.navi.overlay.PoiOverlay;
import com.chenchen.factory.map.navi.util.Utils;

public class NaviActivity extends AppCompatActivity implements AMapLocationListener, PoiSearch.OnPoiSearchListener, AMap.OnInfoWindowClickListener, AMap.OnMarkerClickListener, AMap.InfoWindowAdapter {
    private AMap mMap;
